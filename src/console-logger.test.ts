...
describe('Console Patcher', () => {
    ...
    describe('console.log', () => {
        ...
        it('should pass through simple log call with styling', () => {
            ...
            expect(mockOriginalConsole.log).toHaveBeenCalledWith('%cHello world', 'color: grey');
        });

        it('should handle additional args', () => {
            const obj = { foo: 'bar' };
            globalThis.console.log('Message', obj, 123);
            expect(mockOriginalConsole.log).toHaveBeenCalledWith('%cMessage', 'color: grey', obj, 123);
        });

        it('should apply prefix when provided', () => {
            globalThis.console.log('Body', { prefix: '[API]' } as LoggerOptions, 'arg1');
        ...
        it('should NOT treat first arg as options if it is not an object', () => {
            ...
            expect(mockOriginalConsole.log).toHaveBeenCalledWith('%cMessage', 'color: grey', 'arg1', 'arg2');
        });

        it('should NOT treat array as options', () => {
            const arr = [1, 2, 3];
            globalThis.console.log('Message', arr);
            expect(mockOriginalConsole.log).toHaveBeenCalledWith('%cMessage', 'color: grey', arr);
        });
    ...
    describe('console.log with native %c formatting', () => {
        ...
        it('should prepend prefix and shift user styles correctly', () => {
            globalThis.console.log('%cMyMessage', { prefix: '[LOG]' } as LoggerOptions, 'color:blue');
            expect(mockOriginalConsole.log).toHaveBeenCalledWith(
                '%c[LOG]%c%cMyMessage',  // prefix + %c для тела + %c пользователя
                'color: grey',            // prefix style
                'color: grey',            // body default style
                'color:blue',             // user style
            );
        });

        it('should handle prefix + multiple %c placeholders', () => {
            globalThis.console.log('%cA%cB', { prefix: '[X]' } as LoggerOptions, 'color:blue', 'color:red');
            expect(mockOriginalConsole.log).toHaveBeenCalledWith(
                '%c[X]%c%cA%cB',
                'color: grey',
                'color: grey',
        ...
        it('should handle prefix + groupId + native %c together', () => {
            ...
            globalThis.console.log('%cImportant', { groupId, prefix: '⚠️' }, 'color:orange');
    ...
    describe('console.warn', () => {
        ...
        it('should log warn with yellow color', () => {
            ...
            expect(mockOriginalConsole.log).toHaveBeenCalledWith('%cWarning', 'color: yellow');
        });

        it('should apply prefix with yellow color', () => {
        ...
        it('should support native %c with warn', () => {
            globalThis.console.warn('%cBold%cNormal', 'font-weight:bold', 'font-weight:normal');
            expect(mockOriginalConsole.log).toHaveBeenCalledWith(
    ...
    describe('console.error', () => {
        ...
        it('should log error with red color', () => {
            ...
            expect(mockOriginalConsole.log).toHaveBeenCalledWith('%cError occurred', 'color: red');
        });
        ...
        it('should support native %c with error', () => {
            globalThis.console.error('%cFatal%cRecoverable', 'color:white;background:red', 'color:orange');
            expect(mockOriginalConsole.log).toHaveBeenCalledWith(
    ...
    describe('console.group / groupCollapsed / groupEnd', () => {
        ...
        it('should flush buffered messages on groupEnd', () => {
            ...
            expect(mockOriginalConsole.log).toHaveBeenNthCalledWith(1, '%cMsg 1', 'color: grey');
            expect(mockOriginalConsole.log).toHaveBeenNthCalledWith(2, '%c[X]%cMsg 2', 'color: grey', 'color: grey');
        });
        ...
        it('should respect collapsed state when flushing', () => {
            ...
            expect(mockOriginalConsole.groupCollapsed).toHaveBeenCalledWith('Collapsed');
        ...
        it('should clean buffer after groupEnd', () => {
            ...
            mockOriginalConsole.log.mockClear();
            globalThis.console.groupEnd(groupId);
            expect(mockOriginalConsole.log).not.toHaveBeenCalledWith(expect.stringContaining('Temp'));
        });
        ...
        it('should flush buffered messages with native %c styles preserved', () => {
            ...
            globalThis.console.log('%cRed%cBlue', { groupId }, 'color:red', 'color:blue');
    ...
    describe('Global styles via patchConsole options', () => {
        it('should apply custom default styles from patchConsole', () => {
            ...
            expect(mockOriginalConsole.log).toHaveBeenCalledWith('%cTest', 'color: cyan');

            globalThis.console.warn('Warn');
            expect(mockOriginalConsole.log).toHaveBeenCalledWith('%cWarn', 'color: magenta');

            globalThis.console.error('Err');
            expect(mockOriginalConsole.log).toHaveBeenCalledWith('%cErr', 'color: white;background:black');
    ...
    describe('Edge cases', () => {
        ...
        it('should handle null/undefined args gracefully', () => {
            ...
            expect(mockOriginalConsole.log).toHaveBeenCalledWith('%cTest', 'color: grey', null, undefined);
        });
        ...
        it('should handle empty string prefix', () => {
            ...
            expect(mockOriginalConsole.log).toHaveBeenCalledWith('%cMsg', 'color: grey');
        });
    ...
    describe('Integration: Full workflow', () => {
        it('should handle nested groups with mixed content', () => {
            ...
            expect(mockOriginalConsole.log).toHaveBeenNthCalledWith(1, '%cOuter message', 'color: grey');
            expect(mockOriginalConsole.log).toHaveBeenCalledWith('%cInner buffered', 'color: grey');
            expect(mockOriginalConsole.log).toHaveBeenCalledWith('%cInner error', 'color: red');
        });
        ...
        it('should handle native %c styles in full workflow with groups', () => {
            ...
            globalThis.console.log('%cImportant%cNote', { groupId, prefix: '🔔' }, 'color:blue', 'color:red');

            mockOriginalConsole.log.mockClear();
            globalThis.console.groupEnd(groupId);

            // Ожидаем: префикс (bold) + body default (grey) + user styles (blue, red)
            expect(mockOriginalConsole.log).toHaveBeenCalledWith(
                '%c🔔%c%cImportant%cNote',
                'font-weight:bold',  // global prefixStyle
                'color: grey',        // default body style
